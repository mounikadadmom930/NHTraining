...
namespace employee_id_name_salary_using_4_loops
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                new Employee() { Id = 101, Name = "mounika", salary = 15000 },
                new Employee() { Id = 102, Name = "kavitha", salary = 10000 },
                new Employee() { Id = 103, Name = "pavani", salary = 20000 },
                new Employee() { Id = 104, Name = "pavana", salary = 30000 },
                new Employee() { Id = 105, Name = "chandana", salary = 40000 },
            };
