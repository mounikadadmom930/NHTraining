...
//PUPOSE:PRINT PRODUCT WHOSE PRICE IS >500
//***************************************************************
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
           List< Product> product = new List<Product>
            {
                    new Product() { Id = 101, Name ="book", Price =30, Brand="MADHU"},
                    new Product() { Id = 102, Name ="fan",Price=1000, Brand="GANGA"},
                    new Product() { Id = 103, Name ="chocolate",Price=100, Brand="Dairymilk"},
                    new Product() { Id = 104, Name ="pen",Price=10, Brand="PARKER"},
                    new Product() { Id = 105, Name ="watch",Price=2000, Brand="ROLEX"}
                      };
            Console.WriteLine("**********************");
